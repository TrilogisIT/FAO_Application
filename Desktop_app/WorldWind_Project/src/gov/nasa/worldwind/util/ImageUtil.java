...
public class ImageUtil
{
     ...
     * @see #getMaxMipmapLevel(int, int)
     */
    public static BufferedImage buildMipmap(BufferedImage image, int mipmapImageType)
    {
        if (image == null)
        {
            String message = Logging.getMessage("nullValue.ImageIsNull");
        ...
        {
        	mipMap = new BufferedImage(image.getWidth(), image.getHeight(), mipmapImageType);
            getScaledCopy(image, mipMap);
        }
