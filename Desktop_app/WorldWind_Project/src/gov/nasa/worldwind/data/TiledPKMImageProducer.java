...
/**
 * @author nmeneghini
 * @version $Id: TiledPKMImageProducer.java 1 2014-05-01 15:22:47Z nmeneghini $
 */
public class TiledPKMImageProducer extends TiledRasterProducer {
//		protected static final String DEFAULT_IMAGE_FORMAT = "image/pkm";
//		protected static final String DEFAULT_TEXTURE_FORMAT = "image/pkm";
	...
	protected static final String DEFAULT_TEXTURE_FORMAT = "image/dds";
		...
		// safely re-used.
		protected static DataRasterReader[] readers = new DataRasterReader[] { new GDALDataRasterReader(), new ImageIORasterReader(), new GeotiffRasterReader()  };
		
		public TiledPKMImageProducer(MemoryCache cache, int writeThreadPoolSize) {
			super(cache, writeThreadPoolSize);
		}

		public TiledPKMImageProducer(Sector bbox) {
			super(bbox);
		}
		...
		protected DataRaster createDataRaster(int width, int height, Sector sector, AVList params) {
			...
			BufferedImageRaster raster = new BufferedImageRaster(width, height, transparency, sector,false);
			return raster;
		}
		...
		protected String validateDataSourceParams(AVList params, String name) {
			...
			if (params.hasKey(AVKey.COORDINATE_SYSTEM) && params.getValue(AVKey.COORDINATE_SYSTEM) != AVKey.COORDINATE_SYSTEM_GEOGRAPHIC
