...
/**
 * @author ndorigatti
 * @version $Id: ImprovedFormattedTextField.java 1 2014-05-01 15:22:47Z ndorigatti $
 * <p>
...
public class ImprovedFormattedTextField extends JFormattedTextField {
     ...
     * 
     */
    private static final long serialVersionUID = 7433452417338116970L;
    ...
    /**
     * Create a new {@code ImprovedFormattedTextField} instance which will use {@code aFormat} for the validation of the user input.
     * 
     * @param aFormat
    ...
    /**
     * Create a new {@code ImprovedFormattedTextField} instance which will use {@code aFormat} for the validation of the user input. The field will be initialized with
     * {@code aValue}.
     * 
     * @param aFormat
     *            The format. May not be {@code null}
    ...
    /**
     * Update the background color depending on the valid state of the current input. This provides visual feedback to the user
     */
    ...
    /**
     * @return null if the value is not valid, the value otherwise
     */
    public Double getActualDoubleValue(){
        try {
            commitEdit();
    ...
    private static class MousePositionCorrectorListener extends FocusAdapter {
        ...
        public void focusGained(FocusEvent e) {
            /*
             * After a formatted text field gains focus, it replaces its text with its current value, formatted appropriately of course. It does this after any focus listeners are
             * notified. We want to make sure that the caret is placed in the correct position rather than the dumb default that is before the 1st character !
             */
